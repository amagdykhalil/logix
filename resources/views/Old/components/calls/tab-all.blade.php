@php
    $headers = [
        ...
        ['key' => 'phone_number', 'label' => 'رقم الاتصال'],
        ['key' => 'registered_name', 'label' => 'الاسم المسجل'],
        ['key' => 'call_date', 'label' => 'تاريخ الاتصال'],
        ['key' => 'call_time', 'label' => 'التوقيت'],
        ['key' => 'call_duration', 'label' => 'مدة المكالمة'],
        ['key' => 'call_type', 'label' => 'نوع المكالمة'],
        ['key' => 'call_status', 'label' => 'حالة المكالمة'],
    ...
    $orders = [
        (object) [
            ...
            'registered_name' => 'أحمد عبدالله',
            'call_date' => '2023-10-15',
            'call_time' => '10:30 ص',
            'call_duration' => '5 دقائق',
            'call_type' => 'وارد',
            'call_status' => 'تم الرد',
            'voice_url' => 'sounds/alert1.mp3',
        ],
        (object) [
            'id' => 2,
            'employee' => 'سارة خالد',
            'phone_number' => '+966502345678',
            'registered_name' => 'خالد محمد',
            'call_date' => '2023-10-15',
            'call_time' => '11:45 ص',
            'call_duration' => '2 دقيقة',
            'call_type' => 'صادر',
            'call_status' => 'لم يتم الرد',
            'voice_url' => 'sounds/alert2.mp3',
        ],
        (object) [
            'id' => 3,
            'employee' => 'يوسف أحمد',
            'phone_number' => '+966503456789',
            'registered_name' => 'وليد سامي',
            'call_date' => '2023-10-16',
            'call_time' => '09:15 ص',
            'call_duration' => '7 دقائق',
            'call_type' => 'وارد',
            'call_status' => 'تم الرد',
            'voice_url' => 'sounds/alert3.mp3',
        ],
        (object) [
            'id' => 4,
            'employee' => 'نورا عبدالرحمن',
            'phone_number' => '+966504567890',
            'registered_name' => 'عمر فاروق',
            'call_date' => '2023-10-16',
            'call_time' => '02:30 م',
            'call_duration' => '1 دقيقة',
            'call_type' => 'صادر',
            'call_status' => 'لم يتم الرد',
            'voice_url' => 'sounds/alert4.mp3',
        ],
        (object) [
            'id' => 5,
            'employee' => 'ريماس نواف',
            'phone_number' => '+966505678901',
            'registered_name' => 'سعد عبدالعزيز',
            'call_date' => '2023-10-17',
            'call_time' => '04:20 م',
            'call_duration' => '10 دقائق',
            'call_type' => 'وارد',
            'call_status' => 'تم الرد',
            'voice_url' => 'sounds/alert5.mp3',
        ],
        (object) [
            'id' => 6,
            'employee' => 'فهد سليمان',
            'phone_number' => '+966506789012',
            'registered_name' => 'ماجد ناصر',
            'call_date' => '2023-10-17',
            'call_time' => '05:45 م',
            'call_duration' => '3 دقائق',
            'call_type' => 'صادر',
            'call_status' => 'تم الرد',
            'voice_url' => 'sounds/alert6.mp3',
        ],
        (object) [
            'id' => 7,
            'employee' => 'لينا وليد',
            'phone_number' => '+966507890123',
            'registered_name' => 'بدرية محمد',
            'call_date' => '2023-10-18',
            'call_time' => '12:00 م',
            'call_duration' => '15 دقيقة',
            'call_type' => 'وارد',
            'call_status' => 'تم الرد',
            'voice_url' => 'sounds/alert7.mp3',
        ],
        (object) [
            'id' => 8,
            'employee' => 'زياد إبراهيم',
            'phone_number' => '+966508901234',
            'registered_name' => 'سلمان خالد',
            'call_date' => '2023-10-18',
            'call_time' => '01:30 م',
            'call_duration' => '8 دقائق',
            'call_type' => 'صادر',
            'call_status' => 'لم يتم الرد',
            'voice_url' => 'sounds/alert8.mp3',
        ],
        (object) [
            'id' => 9,
            'employee' => 'هند عبدالله',
            'phone_number' => '+966509012345',
            'registered_name' => 'نواف سعد',
            'call_date' => '2023-10-19',
            'call_time' => '03:15 م',
            'call_duration' => '4 دقائق',
            'call_type' => 'وارد',
            'call_status' => 'تم الرد',
            'voice_url' => 'sounds/alert9.mp3',
        ],
        (object) [
            'id' => 10,
            'employee' => 'بدر محمد',
            'phone_number' => '+966510123456',
            'registered_name' => 'راشد علي',
            'call_date' => '2023-10-19',
            'call_time' => '06:00 م',
            'call_duration' => '12 دقيقة',
            'call_type' => 'صادر',
            'call_status' => 'تم الرد',
            'voice_url' => 'sounds/alert10.mp3',
        ],
    ];
...
<div class="flex justify-between flex-wrap gap-4 mb-4 items-center">
    ...
    <div class="flex gap-3 items-center rtl">
        ...
        <div class="relative">
            ...
            <!-- Flatpickr -->
            <input type="text" id="dateRangePicker" class="mt-2 hidden dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400" placeholder="اختر التاريخ المخصص" />
...
<div class="flex items-center gap-2 flex-wrap mb-4 mt-8">
    ...
    <span class="p-2 flex items-center rounded-lg text-sm bg-[#EDEDFC] dark:bg-indigo-900/20 text-[#5753AB] dark:text-indigo-300 border border-[#EDEDFC] dark:border-indigo-800/50">
        جهة الاتصال :
        <span class="text-black/80 dark:text-gray-200 ml-1">واتساب</span>
        <svg class="cursor-pointer ltr:ml-2 rtl:mr-2 dark:[&>path]:fill-gray-400" width="10" height="9" viewBox="0 0 10 9" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1.81889 0.257392C1.526 -0.0355015 1.05113 -0.0355015 0.758233 0.257392C0.46534 0.550285 0.46534 1.02516 0.758233 1.31805L3.94021 4.50003L0.758263 7.68198C0.46537 7.97487 0.46537 8.44974 0.758263 8.74264C1.05116 9.03553 1.52603 9.03553 1.81892 8.74264L5.00087 5.56069L8.18285 8.74267C8.47575 9.03557 8.95062 9.03557 9.24351 8.74267C9.53641 8.44978 9.53641 7.97491 9.24351 7.68201L6.06153 4.50003L9.24354 1.31802C9.53644 1.02512 9.53644 0.55025 9.24354 0.257357C8.95065 -0.0355363 8.47578 -0.0355359 8.18288 0.257357L5.00087 3.43937L1.81889 0.257392Z" fill="#868FA0"/>
        </svg>
    </span>

...
@php
    ...
    $base =
        'ques-item w-full text-[13px] leading-[33px] tracking-[0%] align-middle font-[400] rounded-[8px] text-center bg-[#F8F8F8] text-gray-500 hover:opacity-80 cursor-pointer px-4 py-0';
@endphp
